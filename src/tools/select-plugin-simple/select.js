...
export class Select {
  ...
  get current () {
    // console.log('select.js current selectedId:', this.selectedId, '(', typeof this.selectedId, ')')
  ...
  select (id) {
    ...
    this.selectedId = id
    if (!this.current) {
      // console.log('select.js select current value is undefined. selectedId:', this.selectedId, '(', typeof this.selectedId, ')')
    ...
    console.log('select.js select. id:', id, 'current', this.current.id, '(', typeof this.current.id, ') previousId', previousSelectedID, '(', typeof previousSelectedID, ')')
