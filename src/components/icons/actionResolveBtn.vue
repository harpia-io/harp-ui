<template>
  <Tooltip tooltipText='Resolve'>
    <button :class="{
    'button__icon': type === 'button__icon',
    'button__icon-transparent': type === 'button__icon-transparent'}">
...
export default {
  ...
  computed: {
    btnColorChecked () {
      return this.active ? '#faa102' : this.btnColor
    }
  }
}
</script>
