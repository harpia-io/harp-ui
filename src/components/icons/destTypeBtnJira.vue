<template>
  <Tooltip :tooltipText="'Created JIRA'">
    <button class="button__icon-transparent" @click="btnStateChange">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="24px" height="24px" fill="none">
